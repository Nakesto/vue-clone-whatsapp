<template>
  <div class="WAL position-relative bg-grey-4" :style="style">
    <q-layout view="lHh Lpr lFf" class="WAL__layout shadow-3" container v-if="!isInitial">
      <router-view></router-view>
    </q-layout>
    <div v-else class="flex flex-center column" style="height: 100vh; background-color: rgb(0,0,0,0.1);">
